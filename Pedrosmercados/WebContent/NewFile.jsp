...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    <a href="#portfolio" onclick="w3_close()" class="w3-bar-item w3-button w3-padding w3-text-teal"><i class="fa fa-user fa-fw w3-margin-right"></i>LOGUIN</a> 
  ...
  <form action="login">
    <div class="form-group">
     ...
     <div class="form-group">
      ...
      <input type="password" class="form-control" id="sobrenome1" placeholder="Coloque sua Senha!" name="senha">
    </div>
...
<br/>
  ...
  <header id="about">
    ...
    <hr>
   <h1>Para ver os podutos você deve estar Logado!</h1>
